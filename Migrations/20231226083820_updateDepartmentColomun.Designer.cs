...
namespace PureCareHub_HospitalCare.Migrations
{
    ...
    [Migration("20231226083820_updateDepartmentColomun")]
    partial class updateDepartmentColomun
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("PureCareHub_HospitalCare.Areas.Identity.Data.ApplicationUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("PureCareHub_HospitalCare.Models.Doctor", b =>
                {
                    b.HasOne("PureCareHub_HospitalCare.Models.Department", "department")
                        .WithMany()
                        .HasForeignKey("depID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
